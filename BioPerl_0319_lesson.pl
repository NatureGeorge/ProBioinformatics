...
my $count_sum = 0;
my $cal;
open(input, '<C:\Users\Nature\Desktop\M-BioPerl\sequence.txt') or die "can not open the file:, $!";
open(output, '>C:\Users\Nature\Desktop\M-BioPerl\sequence_count.txt');
